---
{"title":"SN:E — вызов по адресу","summary":"Получаем адрес GetKeyState из user32.dll, проверяем результат разрешения, вызываем с кодом левого Shift 160. Состояние нажатия читается из бита 15 результата SHORT; пример не меняет состояние игры.","translationStatus":"reviewed"}
---
