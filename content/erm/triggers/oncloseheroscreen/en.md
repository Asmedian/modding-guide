---
{"title":"Closing the hero screen (OnCloseHeroScreen)","summary":"x1 is the hero used to open the window, even if the user subsequently switched heroes.","translationStatus":"reviewed"}
---
