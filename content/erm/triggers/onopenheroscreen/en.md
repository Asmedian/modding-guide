---
{"title":"Opening the hero screen (OnOpenHeroScreen)","summary":"x1 is the hero when the window first opens. Switching heroes inside the window does not repeat this event; use OnLoadHeroScreen or OnPreHeroScreen.","translationStatus":"reviewed"}
---
